        ...
        _enableDrag: function () {
            ...
            $(document).on('mousemove.lobibox', function (ev) {
                if (el.attr('allow-drag') === 'true') {
                    ...
                    var right = $(document).outerWidth() - (left + el.outerWidth() + 2);
                    //var bottom = $(document).outerHeight() - (top + el.outerHeight() + 2); 
                    var oldLeft = left + right;
                    el.css({
                        left: right <= 1 ? (oldLeft < 1 ? 1 : oldLeft) : (left < 1 ? 1 : left),
                        top: top < 1 ? 1 : top
                    });
//                    el.css({
